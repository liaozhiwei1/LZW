...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <a href="<c:url value="/login"/>">返回登陆</a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<c:url value="/"/>">返回首页</a>
      </form></br>
	...
	<div class="modal fade bs-example-modal-sm" id="myModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
		  <div class="modal-dialog modal-sm"  role="document">
		      	<div class="alert alert-danger" role="alert"><span class="glyphicon glyphicon-remove-sign"></span>邮件地址有问题！！！！！   请查正</div>
		  </div>
	</div>
